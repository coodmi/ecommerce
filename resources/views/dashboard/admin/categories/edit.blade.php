...
<div class="p-6">
    ...
    <div class="mb-8">
        <div class="flex items-center space-x-4 mb-4">
            ...
            <div>
                <h1 class="text-3xl font-display font-bold text-gray-900">Edit Category</h1>
    ...
    <div class="max-w-3xl">
        <form action="{{ route('admin.categories.update', $category) }}"
              ...
              x-data="{ imagePreview: '{{ $category->image ? asset('storage/' . $category->image) : '' }}' }">
            @csrf
            @method('PUT')
                ...
                <div>
                    <label class="flex items-center space-x-3">
                        <input type="checkbox"
                               name="is_deal"
                               value="1"
                               {{ old('is_deal', $category->is_deal) ? 'checked' : '' }}
