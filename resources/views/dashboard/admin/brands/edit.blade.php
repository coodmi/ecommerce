...
<div class="p-6">
    <div class="flex items-center space-x-4 mb-8">
        ...
        <div>
            <h1 class="text-3xl font-display font-bold text-gray-900">Edit Brand</h1>
            <p class="text-gray-600 mt-1">Update brand information: {{ $brand->name }}</p>
        </div>
    </div>
        ...
        <form action="{{ route('admin.brands.update', $brand) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="bg-white rounded-[2.5rem] shadow-xl border border-gray-100 p-8">
                <div class="grid md:grid-cols-2 gap-8">
                    ...
                    <!-- Logo Upload -->
                    <div x-data="{ logoPreview: '{{ $brand->logo_url }}' }">
