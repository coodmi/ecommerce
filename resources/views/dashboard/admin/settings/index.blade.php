        ...
        <form action="{{ route('admin.settings.update') }}" method="POST">
            ...
            <div class="bg-white rounded-3xl shadow-sm border border-slate-100 overflow-hidden">
                ...
                <div class="p-8 bg-slate-50 flex justify-end">
                    <button type="submit" class="bg-primary text-white px-10 py-4 rounded-2xl font-bold shadow-xl shadow-primary/20 hover:scale-105 transition-all">
                        <i class="fas fa-check-circle mr-2"></i>Save Visual Settings
                    </button>
                </div>
            </div>
        </form>
