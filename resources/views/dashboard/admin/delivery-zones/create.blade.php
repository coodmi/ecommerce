        ...
        <form method="POST" action="{{ route('admin.delivery-zones.store') }}" class="space-y-5">
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="number" name="charge" value="{{ old('charge') }}" step="0.01" min="0" required
                           placeholder="80"
                ...
                <div>
                    ...
                    <input type="text" name="delivery_time" value="{{ old('delivery_time') }}" required
            ...
            <div>
                ...
                <input type="text" name="icon" value="{{ old('icon', 'fa-map-marker-alt') }}" required
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <label class="flex items-center gap-2 cursor-pointer">
                        <input type="checkbox" name="is_active" value="1" {{ old('is_active', true) ? 'checked' : '' }} class="w-4 h-4 rounded border-gray-300 text-primary focus:ring-primary">
