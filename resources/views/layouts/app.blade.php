...
<body class="bg-gray-50 overflow-x-hidden">
    ...
    @php $waPhone = \App\Models\Setting::get('whatsapp_number', '8801234567890'); @endphp
    <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $waPhone) }}" target="_blank" rel="noopener"
       class="fixed bottom-24 right-6 z-50 w-14 h-14 bg-[#25D366] hover:bg-[#20b858] text-white rounded-full shadow-lg hover:shadow-xl flex items-center justify-center transition-all duration-300 hover:scale-110">
